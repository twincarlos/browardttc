...
export default function EventGroupGallery({ tournamentEvent }: { tournamentEvent: TournamentEvent }) {
  const { eventGroups, isLoading, error } = useEventGroups(tournamentEvent.id.toString());
